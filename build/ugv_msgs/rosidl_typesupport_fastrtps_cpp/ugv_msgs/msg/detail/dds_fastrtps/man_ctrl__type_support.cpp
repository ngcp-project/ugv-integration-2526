...
#include "ugv_msgs/msg/detail/man_ctrl__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ugv_msgs::msg::ManCtrl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ugv_msgs::msg::ManCtrl & ros_message)
{
  // Member: auto_en
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ugv_msgs::msg::ManCtrl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ugv_msgs::msg::ManCtrl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ugv_msgs::msg::ManCtrl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ManCtrl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ugv_msgs::msg::ManCtrl *>(
...
static size_t _ManCtrl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ManCtrl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ManCtrl__callbacks = {
  "ugv_msgs::msg",
  "ManCtrl",
...
static rosidl_message_type_support_t _ManCtrl__handle = {
...
{
  return &ugv_msgs::msg::typesupport_fastrtps_cpp::_ManCtrl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ugv_msgs, msg, ManCtrl)() {
  return &ugv_msgs::msg::typesupport_fastrtps_cpp::_ManCtrl__handle;
}
