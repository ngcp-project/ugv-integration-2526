...
static const _ManCtrl_type_support_symbol_names_t _ManCtrl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ugv_msgs, msg, ManCtrl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ugv_msgs, msg, ManCtrl)),
  }
};
...
{
  return &::ugv_msgs::msg::rosidl_typesupport_cpp::ManCtrl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ugv_msgs, msg, ManCtrl)() {
  return get_message_type_support_handle<ugv_msgs::msg::ManCtrl>();
}
